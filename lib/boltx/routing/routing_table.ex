defmodule Boltx.Routing.RoutingTable do
  @moduledoc ~S"""
  ...
  latest version of Boltx, you could use this query:

      Boltx.query!(Boltx.conn, "call dbms.cluster.routing.getRoutingTable($props)", %{props: %{}})
