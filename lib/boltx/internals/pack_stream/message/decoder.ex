defmodule Boltx.Internals.PackStream.Message.Decoder do
  @moduledoc false
  ...
  @spec build_response(
          Boltx.Internals.PackStream.Message.in_signature(),
          any(),
          integer(),
          integer()
        ) ::
  ...
  defp build_response(message_type, data, nb_entries, bolt_version) do
    ...
    response =
      case Boltx.Internals.PackStream.decode(data, bolt_version) do
