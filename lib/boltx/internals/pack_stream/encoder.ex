...
defprotocol Boltx.Internals.PackStream.Encoder do
  @moduledoc false
...
defimpl PackStream.Encoder, for: Boltx.Types.TimeWithTZOffset do
...
defimpl PackStream.Encoder, for: Boltx.Types.DateTimeWithTZOffset do
  def encode(data, version) do
    EncoderHelper.call_encode(:datetime_with_tz_offset, data, version)
  end
end

defimpl PackStream.Encoder, for: Boltx.Types.Duration do
  def encode(data, version), do: EncoderHelper.call_encode(:duration, data, version)
end

defimpl PackStream.Encoder, for: Boltx.Types.Point do
