defmodule Boltx.Internals.PackStream.EncoderV2 do
  @moduledoc false
  ...
  ## Example
      ...
      iex> :erlang.iolist_to_binary(Boltx.Internals.PackStream.EncoderV2.encode_local_time(~T[06:54:32.453], 2))
  ...
  ## Example
      ...
      iex> time_with_tz = Boltx.Types.TimeWithTZOffset.create(~T[06:54:32.453], 3600)
  ...
  ## Example
      ...
      iex> :erlang.iolist_to_binary(Boltx.Internals.PackStream.EncoderV2.encode_date(~D[2019-04-23], 2))
      <<0xB1, 0x44, 0xC9, 0x46, 0x59>>

  """
  @spec encode_date(Date.t(), integer()) :: Boltx.Internals.PackStream.value()
  ...
  ## Example
      ...
      iex> :erlang.iolist_to_binary(Boltx.Internals.PackStream.EncoderV2.encode_local_datetime(~N[2019-04-23 13:45:52.678], 2))
  ...
  ## Example
      ...
      iex> d = Boltx.TypesHelper.datetime_with_micro(~N[2013-11-12 07:32:02.003],
      ...> "Europe/Berlin")
      #DateTime<2013-11-12 07:32:02.003+01:00 CET Europe/Berlin>
      iex> :erlang.iolist_to_binary(Boltx.Internals.PackStream.EncoderV2.encode_datetime_with_tz_id(d, 2))
  ...
  ## Example
      ...
      iex> d = Boltx.Types.DateTimeWithTZOffset.create(~N[2013-11-12 07:32:02.003], 7200)
      %Boltx.Types.DateTimeWithTZOffset{
              naive_datetime: ~N[2013-11-12 07:32:02.003],
              timezone_offset: 7200
            }
      iex> :erlang.iolist_to_binary(Boltx.Internals.PackStream.EncoderV2.encode_datetime_with_tz_offset(d, 2))
  ...
  ## Example
      ...
      iex> :erlang.iolist_to_binary(Boltx.Internals.PackStream.EncoderV2.encode_duration(d, 2))
  ...
  ## Example
      ...
      iex> p = Boltx.Types.Point.create(:wgs_84, 65.43, 12.54)
      %Boltx.Types.Point{
              crs: "wgs-84",
              height: nil,
              latitude: 12.54,
      ...
      iex> :erlang.iolist_to_binary(Boltx.Internals.PackStream.EncoderV2.encode_point(p, 2))
  ...
  ## Example
      ...
      iex> p = Boltx.Types.Point.create(:wgs_84, 45.0003, 40.3245, 23.1)
      %Boltx.Types.Point{
              crs: "wgs-84-3d",
              height: 23.1,
              latitude: 40.3245,
