defmodule Boltx.Internals.PackStream.EncoderHelper do
  @moduledoc false
  alias Boltx.Internals.BoltVersionHelper
  alias Boltx.Internals.PackStreamError

  use Boltx.Internals.PackStream.V1
  use Boltx.Internals.PackStream.V2
  use Boltx.Internals.PackStream.Utils
