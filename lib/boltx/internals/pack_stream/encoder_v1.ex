defmodule Boltx.Internals.PackStream.EncoderV1 do
  @moduledoc false
  ...
  ## Example
      ...
      iex> alias Boltx.Internals.PackStream.EncoderV1
  ...
  """
  @spec encode_list(list(), integer()) :: Boltx.Internals.PackStream.value()
