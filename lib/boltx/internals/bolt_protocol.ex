defmodule Boltx.Internals.BoltProtocol do
  @moduledoc false
  ...
  #   - `:log`: (bool) wether Boltx.Internals. should produce logs or not. Defaults to `false`
  #   - `:log_hex`: (bool) wether Boltx.Internals. should produce logs hexadecimal counterparts. While this may be interesting,
  ...
  # ```
  #   config :Boltx.Internals.,
  #     log: true,
  #     log_hex: true
  # ```
  #   # #### Examples of logging (without log_hex)

  #     iex> Boltx.Internals.test('localhost', 7687, "RETURN 1 as num", %{}, {"neo4j", "password"})
  #     C: HANDSHAKE ~ "<<0x60, 0x60, 0xB0, 0x17>> [2, 1, 0, 0]"
  #     S: HANDSHAKE ~ 2
  #     C: INIT ~ ["boltx/1.1.0.rc2", %{credentials: "password", principal: "neo4j", scheme: "basic"}]
  ...
  alias Boltx.Internals.BoltProtocolV1
  alias Boltx.Internals.BoltProtocolV3
  ...
  @spec run(
          ...
          String.t(),
          map(),
          nil | Keyword.t() | Boltx.Metadata.t(),
          nil | Keyword.t()
        ) ::
          {:ok, tuple()}
