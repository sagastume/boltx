defmodule Boltx.Internals.BoltProtocolV3 do
  ...
  ## Examples
      ...
      iex> Boltx.Internals.BoltProtocolV3.hello(:gen_tcp, port, 3, {}, [])
      {:ok, info}

      iex> Boltx.Internals.BoltProtocolV3.hello(:gen_tcp, port, 3, {"username", "password"}, [])
      {:ok, info}
  """
  ...
  ## Examples
      ...
      iex> Boltx.Internals.BoltProtocolV3.goodbye(:gen_tcp, port, 3)
      :ok
  ...
  """
  @spec run(atom(), port(), integer(), String.t(), map(), Boltx.Metadata.t(), Keyword.t()) ::
          {:ok, any()} | {:error, Boltx.Internals.Error.t()}
  ...
  ## Example
      ...
      {:ok, metadata}
  """
  @spec begin(atom(), port(), integer(), Boltx.Metadata.t() | map(), Keyword.t()) ::
          {:ok, any()} | Boltx.Internals.Error.t()
  ...
  ## Example
      ...
      :ok
  """
  @spec rollback(atom(), port(), integer(), Keyword.t()) :: :ok | Boltx.Internals.Error.t()
