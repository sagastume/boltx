defmodule Boltx.Internals.Error do
  @moduledoc false
  ...
  @doc false
  # Produce a Boltx.Internals.Error depending on the context.
  @spec exception(any(), nil | port(), atom()) :: Boltx.Internals.Error.t()
  ...
  def exception(%Boltx.Internals.Error{} = err, _pid, _function), do: err
